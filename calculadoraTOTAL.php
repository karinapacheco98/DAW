...
?>
		...
		<br>
			Número 1: <input type="text" size="20" name="num1" value=<?php echo "$n1"; ?>><br><br>
			Número 2: <input type="text" size="20" name="num2" value=<?php echo "$n2"; ?>> <br><br>
			...
			Resultado: 	<input type="text" name="resultado" value= <?php echo "$resultado";?>> <br><br>
